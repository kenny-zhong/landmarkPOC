<script type=text/javascript>
  ...
  var landmarkStart;
  var landmarkEnd;
  var nearStation,nearStationDist,landmarkNewTag,landmark_changelink,landmark_newJobsource;
  ...
  landmark_el.src = 'https://www.104.com.tw/jobs/search/static/preserve/jobs_MRTdistances_0506.js';
  ...
  landmarkPocJobNoList = landmark_jobs;
  landmarkPocClassifier = '{{JS - random_classifier}}'; //0,1,2
  ...
  continue;
    ...
    switch (String(landmarkPocClassifier) + '-' + landmarkSource ){
      case "1" :
        ...
        if(landmark_admin.innerText.search("公尺") == -1 ){
          landmark_admin.innerText += landmarkNewTag;
        }
        landmark_changelink[0].setAttribute('href' , landmark_newJobsource + 'A' );
        ga('send', {
          hitType: 'event',
          eventCategory: '地標POC',
          eventAction: 'impression_GroupA',
          eventLabel: jobNo
        });
        break;
      case "2" :
        ...
        landmark_changelink[0].setAttribute('href' , landmark_newJobsource + 'B' );
        ga('send', {
          hitType: 'event',
          eventCategory: '地標POC',
          eventAction: 'impression_GroupB',
          eventLabel: jobNo
        });
        break;
      case "0"  :
        landmark_changelink[0].setAttribute('href' , landmark_newJobsource + 'C' )
        ga('send', {
          hitType: 'event',
          eventCategory: '地標POC',
          eventAction: 'impression_GroupC',
          eventLabel: jobNo
        });
        break;
        default :
